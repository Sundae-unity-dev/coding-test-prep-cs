...
var CACHE = 'ctcamp-shell-v53';
var SHELL = [
  BASE, BASE + 'index.html', BASE + 'guide.html', BASE + 'concepts.html', BASE + 'practice.html', BASE + 'gichul.html', BASE + 'progress.html', BASE + 'path.html', BASE + 'sql.html', BASE + 'qa.html',
  ...
  BASE + 'assets/qa-data.js', BASE + 'assets/sql-problems.js', BASE + 'assets/sql-wasm.js',
